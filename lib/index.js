import { ref as yi, reactive as Lr, onMounted as Br, nextTick as Ir, watch as Nr, onUnmounted as Vr, defineComponent as Yr, openBlock as Ur, createElementBlock as Xr, normalizeClass as xi, createElementVNode as qr, unref as Me, normalizeStyle as Gr } from "vue";
function mt(u) {
  if (u === void 0)
...
var it = {
  ...
  overwrite: !1,
  delay: 0
}, ti, W, V, at = 1e8, D = 1 / at, Ne = Math.PI * 2, Wr = Ne / 4, Hr = 0, Bi = Math.sqrt, $r = Math.cos, Kr = Math.sin, X = function(t) {
...
}, H = Array.isArray, Ve = /(?:-?\.?\d|\.)+/gi, Ni = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Ut = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, De = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, Vi = /[+-]=-?[.\d]+/, Yi = /[^,'"\[\]\s]+/gi, Qr = /^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i, A, st, Ye, ri, rt = {}, ye = {}, Ui, Xi = function(t) {
  return (ye = Nt(t, rt)) && J;
}, ni = function(t, e) {
  ...
  suppressEvents: !0
}, si = {}, wt = [], Ue = {}, Gi, tt = {}, Ee = {}, vi = 30, me = [], ai = "", oi = function(t) {
  var e = t[0], i, r;
  ...
  var e = t.parent || A, i = t.keyframes ? tn(H(t.keyframes)) : ft;
  if (Q(t.inherit))
    for (; e; )
  ...
  var i;
  if ((e._time || e._initted && !e._dur) && (i = be(t.rawTime(), e), (!e._dur || ce(0, e.totalDuration(), i) - e._tTime > D) && e.render(i, !0)), Bt(t, e)._dp && t._initted && t._time >= t._dur && t._ts) {
  ...
  var n = t.ratio, s = e < 0 || !e && (!t._start && sn(t) && !(!t._initted && qe(t)) || (t._ts < 0 || t._dp._ts < 0) && !qe(t)) ? 0 : 1, a = t._rDelay, o = 0, f, h, _;
  ...
  var r = t.labels, n = t._recent || un, s = t.duration() >= at ? n.endTime(!1) : t._dur, a, o, f;
  ...
  return V && !e && V.selector ? V.selector(t) : X(t) && !i && (Ye || !Qt()) ? Ge.call((e || ri).querySelectorAll(t), 0) : H(t) ? hn(t, i) : tr(t) ? Ge.call(t, 0) : t ? [t] : [];
}, We = function(t) {
  ...
  return X(r) ? h = _ = {
    ...
    var l = (m || e).length, p = s[l], g, y, x, T, v, S, P, w, b;
    if (!p) {
      if (b = e.grid === "auto" ? 0 : (e.grid || [1, at])[1], !b) {
        for (P = -at; P < (P = m[b++].getBoundingClientRect().left) && b < l; )
          ;
        b--;
      }
      for (p = s[l] = [], g = o ? Math.min(b, l) * h - 0.5 : r % b, y = b === at ? 0 : o ? l * _ / b - 0.5 : r / b | 0, P = 0, w = at, S = 0; S < l; S++)
        x = S % b - g, T = y - (S / b | 0), p[S] = v = f ? Math.abs(f === "y" ? T : x) : Bi(x * x + T * T), v > P && (P = v), v < w && (w = v);
      r === "random" && er(p), p.max = P - w, p.min = w, p.v = l = (parseFloat(e.amount) || parseFloat(e.each) * (b > l ? l - 1 : f ? f === "y" ? l / b : b : Math.max(b, l / b)) || 0) * (r === "edges" ? -1 : 1), p.b = l < 0 ? n - l : n, p.u = G(e.amount || e.each) || 0, i = i && l < 0 ? _r(i) : i;
    }
  ...
  if (n)
    return o = r[e + "Params"], f = r.callbackScope || t, i && wt.length && ve(), a && (V = a), h = o ? n.apply(f, o) : n.call(f), V = s, h;
}, ie = function(t) {
...
}(), gn = /hsl[a]?\(/, lr = function(t) {
  var e = t.join(" "), i;
  if (Pt.lastIndex = 0, Pt.test(e))
    return i = gn.test(e), t[1] = Si(t[1], i), t[0] = Si(t[0], i, hr(t[1])), !0;
}, fe, et = function() {
  ...
  return !fe && et.wake();
}, O = {}, yn = /^[\d.\-M][\d.\-,\s]/, xn = /["']/g, vn = function(t) {
  for (var e = {}, i = t.substr(1, t.length - 3).split(":"), r = i[0], n = 1, s = i.length, a, o, f; n < s; n++)
    o = i[n], a = n !== s - 1 ? o.lastIndexOf(",") : o.length, f = o.substr(0, a), e[r] = isNaN(f) ? f.replace(xn, "").trim() : +f, r = o.substr(a + 1).trim();
  return e;
}, Tn = function(t) {
  ...
  return i && e.length > 1 && i.config ? i.config.apply(null, ~t.indexOf("{") ? [vn(e[1])] : Tn(t).split(",").map($i)) : O._CE && yn.test(t) ? O._CE("", t) : i;
}, _r = function(t) {
  return function(e) {
    return 1 - t(1 - e);
  };
...
var pr = function(t, e) {
  this.id = Hr++, t._gsap = this, this.target = t, this.harness = e, this.get = e ? e.get : Wi, this.set = e ? e.getSetter : li;
  ...
  return t.delay = function(i) {
    ...
    return this._rts = +i || 0, this._ts = this._ps || i === -D ? 0 : this._rts, this.totalTime(ce(-Math.abs(this._delay), this._tDur, r), !0), ke(this), rn(this);
  }, t.paused = function(i) {
...
var K = /* @__PURE__ */ function(u) {
  ...
  return e.to = function(r, n, s) {
    ...
    if (this !== A && h > o && r >= 0 && (h = o), h !== this._tTime || s || _) {
      if (a !== this._time && f && (h += this._time - a, r += this._time - a), c = h, T = this._start, x = this._ts, g = !x, _ && (f || (a = this._zTime), (r || !n) && (this._zTime = r)), this._repeat) {
        ...
        if (c = q(h % p), h === o ? (l = this._repeat, c = f) : (l = ~~(h / p), l && l === h / p && (c = f, l--), c > f && (c = f)), v = $t(this._tTime, p), !a && this._tTime && v !== l && this._tTime - v * p - this._dur <= 0 && (v = l), S && l & 1 && (c = f - c, P = 1), l !== v && !this._lock) {
          var w = S && v & 1, b = w === (S && l & 1);
          if (l < v && (w = !w), a = w ? 0 : f, this._lock = 1, this.render(a || (P ? 0 : q(l * p)), n, !f)._lock = 0, this._tTime = h, !n && this.parent && ut(this, "onRepeat"), this.vars.repeatRefresh && !P && (this.invalidate()._lock = 1), a && a !== this._time || g !== !this._ts || this.vars.onRepeat && !this.parent && !this._act)
            return this;
      ...
      if (this._hasPause && !this._forcing && this._lock < 2 && (y = on(this, q(a), q(c)), y && (h -= c - (c = y._start))), this._tTime = h, this._time = c, this._act = !x, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = r, a = 0), !a && c && !n && !l && (ut(this, "onStart"), this._tTime !== h))
        return this;
      if (c >= a && r >= 0)
        for (d = this._first; d; ) {
    ...
    for (var s = [], a = ot(r), o = this._first, f = yt(n), h; o; )
      o instanceof U ? Jr(o._targets, a) && (f ? (!vt || o._initted && o._ts) && o.globalTime(0) <= n && o.globalTime(o.totalDuration()) > n : !n || o.isActive()) && s.push(o) : (h = o.getTweensOf(a, n)).length && s.push.apply(s, h), o = o._next;
    return s;
    ...
    if (A._ts && (Hi(A, be(r, A)), Gi = et.frame), et.frame >= vi) {
      vi += it.autoSleep || 120;
      var n = A._first;
...
var wn = function(t, e, i, r, n, s, a) {
  ...
  F(r) && (r = r(n || 0, t, s));
  var _ = t[e], c = i !== "get" ? i : F(_) ? f ? t[e.indexOf("set") || !F(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](f) : t[e]() : _, d = F(_) ? f ? Cn : xr : hi, m;
  if (X(r) && (~r.indexOf("random(") && (r = ue(r)), r.charAt(1) === "=" && (m = qt(c, r) + (G(c) || 0), (m || m === 0) && (r = m))), !h || c !== r || $e)
    return !isNaN(c * r) && r !== "" ? (m = new Z(this._pt, t, e, +c || 0, r - (c || 0), typeof _ == "boolean" ? Dn : vr, 0, d), f && (m.fp = f), a && m.modifier(a, this, t), this._pt = m) : (!_ && !(e in t) && ni(e, r), wn.call(this, t, e, c, r, d, o || it.stringFilter, f));
  ...
  var a, o, f, h;
  if (tt[t] && (a = new tt[t]()).init(n, a.rawVars ? e[t] : Pn(e[t], r, n, s, i), i, r, s) !== !1 && (i._pt = o = new Z(i._pt, n, t, 0, 1, a.render, a, 0, a.priority), i !== Xt))
    for (f = i._ptLookup[i._targets.indexOf(n)], h = a._props.length; h--; )
      f[a._props[h]] = o;
  return a;
}, vt, $e, fi = function u(t, e, i) {
  var r = t.vars, n = r.ease, s = r.startAt, a = r.immediateRender, o = r.lazy, f = r.onUpdate, h = r.onUpdateParams, _ = r.callbackScope, c = r.runBackwards, d = r.yoyoEase, m = r.keyframes, l = r.autoRevert, p = t._dur, g = t._startAt, y = t._targets, x = t.parent, T = x && x.data === "nested" ? x.vars.targets : y, v = t._overwrite === "auto" && !ti, S = t.timeline, P, w, b, k, C, z, B, I, E, Y, N, $, Ct;
  if (S && (!m || !n) && (n = "none"), t._ease = It(n, Ht.ease), t._yEase = d ? _r(It(d === !0 ? n : d, Ht.ease)) : 0, d && t._yoyo && !t._repeat && (d = t._yEase, t._yEase = t._ease, t._ease = d), t._from = !S && !!r.runBackwards, !S || m && !r.stagger) {
    if (I = y[0] ? Lt(y[0]).harness : 0, $ = I && r[I.prop], P = Te(r, si), g && (g._zTime < 0 && g.progress(1), e < 0 && c && a && !l ? g.render(-1, !0) : g.revert(c && p ? pe : jr), g._lazy = 0), s) {
      ...
      }, P), $ && (b[I.prop] = $), St(t._startAt = U.set(y, b)), t._startAt._dp = 0, t._startAt._sat = t, e < 0 && (W ? t._startAt.revert(pe) : t._startAt.render(-1, !0)), t._zTime = e, !a)
        u(t._startAt, D, D);
      else if (!e)
        return;
    }
    for (t._pt = t._ptCache = 0, o = p && Q(o) || o && !p, w = 0; w < y.length; w++) {
      if (C = y[w], B = C._gsap || oi(y)[w]._gsap, t._ptLookup[w] = Y = {}, Ue[B.id] && wt.length && ve(), N = T === y ? w : T.indexOf(C), I && (E = new I()).init(C, $ || P, t, N, T) !== !1 && (t._pt = k = new Z(t._pt, C, E.name, 0, 1, E.render, E, 0, E.priority), E._props.forEach(function(Mt) {
        Y[Mt] = k;
      }), E.priority && (z = 1)), !I || $)
        for (b in P)
          tt[b] && (E = mr(b, P, t, N, C, T)) ? E.priority && (z = 1) : Y[b] = k = ui.call(t, C, b, "get", P[b], N, T, 0, r.stringFilter);
      t._op && t._op[w] && t.kill(C, t._op[w]), v && t._pt && (vt = t, A.killTweensOf(C, Y, t.globalTime(e)), Ct = !t.parent, vt = 0), t._pt && o && (Ue[B.id] = 1);
    }
    z && br(t), t._onInit && t._onInit(t);
  }
  t._onUpdate = f, t._initted = (!t._op || t._pt) && !Ct, m && e <= 0 && S.render(at, !0, !0);
}, Sn = function(t, e, i, r, n, s, a) {
...
var U = /* @__PURE__ */ function(u) {
  ...
  function t(i, r, n, s) {
    ...
    var o = a.vars, f = o.duration, h = o.delay, _ = o.immediateRender, c = o.stagger, d = o.overwrite, m = o.keyframes, l = o.defaults, p = o.scrollTrigger, g = o.yoyoEase, y = r.parent || A, x = (H(i) || Ii(i) ? yt(i[0]) : "length" in r) ? [i] : ot(i), T, v, S, P, w, b, k, C;
    if (a._targets = x.length ? oi(x) : xe("GSAP target " + i + " not found. https://greensock.com", !it.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = d, m || c || de(f) || de(h)) {
      if (r = a.vars, T = a.timeline = new K({
        ...
        if (P = x.length, k = c && ir(c), dt(c))
          for (w in c)
            ~gr.indexOf(w) && (C || (C = {}), C[w] = c[w]);
        for (v = 0; v < P; v++)
          S = Te(r, yr), S.stagger = 0, g && (S.yoyoEase = g), C && Nt(S, C), b = x[v], S.duration = +ae(f, mt(a), v, b, x), S.delay = (+ae(h, mt(a), v, b, x) || 0) - a._delay, !c && P === 1 && S.delay && (a._delay = h = S.delay, a._start += h, S.delay = 0), T.to(b, S, k ? k(v, b, x) : 0), T._ease = O.none;
        ...
        if (H(m))
          ...
          S = {};
          for (w in m)
            w === "ease" || w === "easeEach" || kn(w, m[w], S, m.easeEach);
          for (w in S)
            for (B = S[w].sort(function(Y, N) {
              return Y.t - N.t;
            }), z = 0, v = 0; v < B.length; v++)
              I = B[v], E = {
                ease: I.e,
                duration: (I.t - (v ? B[v - 1].t : 0)) / 100 * f
              }, E[w] = I.v, T.to(x, E, z), z += E.duration;
          T.duration() < f && T.to({}, {
      ...
      a.timeline = 0;
    return d === !0 && !ti && (vt = mt(a), A.killTweensOf(x), vt = 0), lt(y, mt(a), n), r.reversed && a.reverse(), r.paused && a.paused(!0), (_ || !f && !m && a._start === q(y._time) && Q(_) && nn(mt(a)) && y.data !== "nested") && (a._tTime = -D, a.render(Math.max(0, -h) || 0)), p && Zi(mt(a), p), a;
  }
  var e = t.prototype;
  return e.render = function(r, n, s) {
    ...
    return this._initted || fi(this, o), f = this._ease(o / this._dur), Sn(this, r, n, s, a, f, o) ? this.resetTo(r, n, s, a) : (Ce(this, 0), this.parent || Qi(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0), this.render(0));
  }, e.kill = function(r, n) {
...
var hi = function(t, e, i) {
  ...
  return F(t[e]) ? xr : ei(t[e]) && t.setAttribute ? Mn : hi;
}, vr = function(t, e) {
...
it.stringFilter = lr;
var Zt = [], ge = {}, zn = [], Oi = 0, Fe = function(t) {
  return (ge[t] || zn).map(function(e) {
    return e();
  });
}, Ke = function() {
  var t = Date.now(), e = [];
...
var Ln = function(t, e) {
  ...
  for (r in e)
    for (n = i.length; n--; )
      s = t._ptLookup[n][r], s && (s = s.d) && (s._pt && (s = Ln(s, r)), s && s.modifier && s.modifier(e[r], t, i[n], r));
}, Le = function(t, e) {
  return {
    name: t,
    rawVars: 1,
...
}, Le("roundProps", He), Le("modifiers"), Le("snap", rr)) || we;
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var ki, Tt, Gt, ci, Ft, Ci, di, In = function() {
  return typeof window < "u";
}, xt = {}, zt = 180 / Math.PI, Wt = Math.PI / 180, Yt = Math.atan2, Mi = 1e8, pi = /([A-Z])/g, Nn = /(left|right|width|margin|padding|x)/i, Vn = /[\s,\(]\S/, _t = {
...
}, R = "transform", ht = R + "Origin", Qn = function u(t, e) {
  ...
  In() && window.document && (ki = window, Tt = ki.document, Gt = Tt.documentElement, Ft = je("div") || {
    style: {}
  ...
  var n = parseFloat(i) || 0, s = (i + "").trim().substr((n + "").length) || "px", a = Ft.style, o = Nn.test(e), f = t.tagName.toLowerCase() === "svg", h = (f ? "client" : "offset") + (o ? "Width" : "Height"), _ = 100, c = r === "px", d = r === "%", m, l, p, g;
  return r === s || !n || Ai[r] || Ai[s] ? n : (s !== "px" && !c && (n = u(t, e, i, "px")), g = t.getCTM && Dr(t), (d || s === "%") && (xt[e] || ~e.indexOf("adius")) ? (m = g ? t.getBBox()[o ? "width" : "height"] : t[h], L(d ? n / m * _ : n / 100 * m)) : (a[o ? "width" : "height"] = _ + (c ? s : r), l = ~e.indexOf("adius") || r === "em" && t.appendChild && !f ? t : t.parentNode, g && (l = (t.ownerSVGElement || {}).parentNode), (!l || l === Tt || !l.appendChild) && (l = Tt.body), p = l._gsap, p && d && p.width && o && p.time === et.time && !p.uncache ? L(n / p.width * _) : ((d || s === "%") && !Zn[ct(l, "display")] && (a.position = ct(t, "position")), l === t && (a.position = "static"), l.appendChild(Ft), m = Ft[h], l.removeChild(Ft), a.position = "absolute", o && d && (p = Lt(l), p.time = et.time, p.width = l[h]), L(c ? m * n / _ : m && n ? _ / m * n : 0))));
}, gt = function(t, e, i, r) {
  var n;
  ...
  clearProps: function(t, e, i, r, n) {
    if (n.data !== "isFromStart") {
      var s = t._pt = new Z(t._pt, e, i, 0, 0, es);
  ...
  */
  ...
  if (x && (_ !== At || h !== At)) {
    var S = parseFloat(h) * Wt, P = Math.sin(S), w = Math.cos(S), b;
    S = parseFloat(_) * Wt, b = Math.cos(S), s = Ie(y, s, P * b * -x), a = Ie(y, a, -Math.sin(S) * -x), o = Ie(y, o, w * b * -x + x);
  }
  ...
  var i = e || this, r = i.xPercent, n = i.yPercent, s = i.x, a = i.y, o = i.rotation, f = i.skewX, h = i.skewY, _ = i.scaleX, c = i.scaleY, d = i.target, m = i.xOrigin, l = i.yOrigin, p = i.xOffset, g = i.yOffset, y = i.forceCSS, x = parseFloat(s), T = parseFloat(a), v, S, P, w, b;
  o = parseFloat(o), f = parseFloat(f), h = parseFloat(h), h && (h = parseFloat(h), f += h, o += h), o || f ? (o *= Wt, f *= Wt, v = Math.cos(o) * _, S = Math.sin(o) * _, P = Math.sin(o - f) * -c, w = Math.cos(o - f) * c, f && (h *= Wt, b = Math.tan(f - h), b = Math.sqrt(1 + b * b), P *= b, w *= b, h && (b = Math.tan(h), b = Math.sqrt(1 + b * b), v *= b, S *= b)), v = L(v), S = L(S), P = L(P), w = L(w)) : (v = _, w = c, S = P = 0), (x && !~(s + "").indexOf("px") || T && !~(a + "").indexOf("px")) && (x = Ot(d, "x", s, "px"), T = Ot(d, "y", a, "px")), (m || l || p || g) && (x = L(x + m - (m * v + l * P) + p), T = L(T + l - (m * S + l * w) + g)), (r || n) && (b = d.getBBox(), x = L(x + r / 100 * b.width), T = L(T + n / 100 * b.height)), b = "matrix(" + v + "," + S + "," + P + "," + w + "," + x + "," + T + ")", d.setAttribute("transform", b), y && (d.style[R] = b);
}, ns = function(t, e, i, r, n) {
  var s = 360, a = X(n), o = parseFloat(n) * (a && ~n.indexOf("rad") ? zt : 1), f = o - r, h = r + f + "deg", _, c;
  return a && (_ = n.split("_")[1], _ === "short" && (f %= s, f !== f % (s / 2) && (f += f < 0 ? s : -s)), _ === "cw" && f < 0 ? f = (f + s * Mi) % s - ~~(f / s) * s : _ === "ccw" && f > 0 && (f = (f - s * Mi) % s - ~~(f / s) * s)), t._pt = c = new Z(t._pt, e, i, r, f, Yn), c.e = h, c.u = "deg", t._props.push(i), c;
}, Fi = function(t, e) {
  for (var i in e)
    t[i] = e[i];
  return t;
...
var zr = {
  ...
  init: function(t, e, i, r, n) {
    var s = this._props, a = t.style, o = i.vars.startAt, f, h, _, c, d, m, l, p, g, y, x, T, v, S, P, w;
    ci || Ze(), this.styles = this.styles || kr(t), w = this.styles.props, this.tween = i;
    for (l in e)
      if (l !== "autoRound" && (h = e[l], !(tt[l] && mr(l, e, i, r, t, n)))) {
        if (d = typeof h, m = Pe[l], d === "function" && (h = h.call(i, r, t, n), d = typeof h), d === "string" && ~h.indexOf("random(") && (h = ue(h)), m)
          ...
          f = (getComputedStyle(t).getPropertyValue(l) + "").trim(), h += "", Pt.lastIndex = 0, Pt.test(f) || (p = G(f), g = G(h)), g ? p !== g && (f = Ot(t, l, f, g) + g) : p && (h += p), this.add(a, "setProperty", f, h, r, n, 0, 0, l), s.push(l), w.push(l, 0, a[l]);
        else if (d !== "undefined") {
          if (o && l in o ? (f = typeof o[l] == "function" ? o[l].call(i, r, t, n) : o[l], X(f) && ~f.indexOf("random(") && (f = ue(f)), G(f + "") || (f += it.units[l] || G(gt(t, l)) || ""), (f + "").charAt(1) === "=" && (f = gt(t, l))) : f = gt(t, l), c = parseFloat(f), y = d === "string" && h.charAt(1) === "=" && h.substr(0, 2), y && (h = h.substr(2)), _ = parseFloat(h), l in _t && (l === "autoAlpha" && (c === 1 && gt(t, "visibility") === "hidden" && _ && (c = 0), w.push("visibility", 0, a.visibility), bt(this, a, "visibility", c ? "inherit" : "hidden", _ ? "inherit" : "hidden", !_)), l !== "scale" && l !== "transform" && (l = _t[l], ~l.indexOf(",") && (l = l.split(",")[0]))), x = l in xt, x) {
            if (this.styles.save(l), T || (v = t._gsap, v.renderTransform && !e.parseTransform || _e(t, e.parseTransform), S = e.smoothOrigin !== !1 && v.smooth, T = this._pt = new Z(this._pt, a, R, 0, 1, v.renderTransform, v, 0, -1), T.dep = 1), l === "scale")
              ...
              w.push(ht, 0, a[ht]), h = ts(h), v.svg ? Je(t, h, 0, S, 0, this) : (g = parseFloat(h.split(" ")[2]) || 0, g !== v.zOrigin && bt(this, v, "zOrigin", v.zOrigin, g), bt(this, a, l, Se(f), Se(h)));
              continue;
            } else if (l === "svgOrigin") {
              Je(t, h, 1, S, 0, this);
              continue;
            } else if (l in Er) {
              ns(this, v, l, c, y ? qt(c, y + h) : h);
              continue;
            } else if (l === "smoothOrigin") {
              bt(this, v, "smooth", v.smooth, h);
              continue;
            } else if (l === "force3D") {
              v[l] = h;
              continue;
            ...
            l in a || (l = Jt(l) || l);
          if (x || (_ || _ === 0) && (c || c === 0) && !Vn.test(h) && l in a)
            p = (f + "").substr((c + "").length), _ || (_ = 0), g = G(h) || (l in it.units ? it.units[l] : p), p !== g && (c = Ot(t, l, f, g)), this._pt = new Z(this._pt, x ? v : a, l, c, (y ? qt(c, y + _) : _) - c, !x && (g === "px" || l === "zIndex") && e.autoRound !== !1 ? Xn : Qe), this._pt.u = g || 0, p !== g && g !== "%" && (this._pt.b = f, this._pt.r = Un);
          else if (l in a)
            Jn.call(this, t, l, f, y ? y + h : h);
          else if (l in t)
          ...
          x || (l in a ? w.push(l, 0, a[l]) : w.push(l, 1, f || t[l])), s.push(l);
        }
      }
    P && br(this);
  },
  ...
  getSetter: function(t, e, i) {
    var r = _t[e];
    return r && r.indexOf(",") < 0 && (e = r), e in xt && e !== ht && (t._gsap.x || gt(t, "x")) ? i && Ci === i ? e === "scale" ? Hn : Wn : (Ci = i || {}) && (e === "scale" ? $n : Kn) : t.style && !ei(t.style[e]) ? qn : ~e.indexOf("-") ? Gn : li(t, e);
  },
  core: {
    _removeProperty: he,
    _getMatrix: mi
...
function as(u, t) {
  const e = yi();
  let i = 0, r = yi(!1);
  const n = Lr({ x: 0, y: 0 }), s = { x: 0, y: 0 }, a = { left: 0, right: 0, top: 0, bottom: 0 }, o = (p) => p.type.includes("touch") ? p.changedTouches[0] : p, f = (p) => {
    var y;
    if (u.disable)
      return;
    const g = o(p);
    ...
    if (!r.value)
      return;
    const g = o(p);
    if (g.pageX < a.left || g.pageX > a.right || g.pageY < a.top || g.pageY > a.bottom) {
      d(g);
      return;
    }
  ...
  return Nr(() => u.eventProcessEl, (p, g) => {
    m();
  }), l(window, !0), Vr(() => {
    l(window, !1);
  ...
  setup(u, { emit: t }) {
    ...
    return (s, a) => (Ur(), Xr("div", {
      ...
      qr("div", {
        ...
        ref: r,
        style: Gr({ left: Me(i).x + "px", top: Me(i).y + "px" })
      }, null, 6)
    ], 2));
  }
});
const us = (u, t) => {
  ...
  for (const [i, r] of t)
    e[i] = r;
  return e;
}, hs = /* @__PURE__ */ us(os, [["__scopeId", "data-v-6a7713b2"]]);
export {
  hs as HandleControl
};
